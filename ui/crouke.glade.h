char *s = N_("About Crouke");
char *s = N_("All");
/* xgettext:no-c-format */
char *s = N_("Apache License\n"
             ...
             "");
char *s = N_("Back");
char *s = N_("Copyright 2008 Yongjian (Jim) Xu\n"
             "\n"
             ...
             " under the License.");
/* An artwork aggregation and management tool for gnome-look.org website group. */
char *s = N_("Crouke");
char *s = N_("Forward");
char *s = N_("Home");
char *s = N_("Local");
